#============================================================#
# Simulation: Consistent Mediation with Absolute Prop. Mediated
...
# Combine data
AbsPM.SimStats.Consistent <- bind_rows(results)
...
write.csv(AbsPM.SimStats.Consistent, file="AbsPM.SimStats.Consistent.csv", row.names = TRUE)
### Save R Data for replication / backtracking
save.image("AbsPM.SimStats.Consistent_Results.RData")